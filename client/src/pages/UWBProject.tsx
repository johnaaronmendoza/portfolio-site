  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="sticky top-0 z-30 bg-black border-b-2 border-amber-400 px-4 sm:px-8 py-3 flex items-center gap-4">
        ...
        <span className="font-pixel text-xs text-gray-600">/ UWB_INDOOR_LOCALIZATION</span>
      </div>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          <FramerReveal>
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              {["Python", "scikit-learn", "SVM-RBF", "Logistic Regression", "PCA", "RobustScaler", "Pandas", "Matplotlib", "NumPy"].map(t => (
          ...
          <FramerReveal>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-center">
              {[
                ...
                <div key={label}>
                  <p className="font-pixel text-amber-400 text-base sm:text-lg mb-1">{value}</p>
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          ...
          <FramerReveal>
            <div className="space-y-3">
              ...
              <img src={classDistImg} alt="Class distribution" className="w-full border-4 border-amber-400 shadow-8bit" />
            </div>
          </FramerReveal>
          ...
          <FramerReveal>
            <div className="space-y-3">
              ...
              <img src={confusionImg} alt="Confusion matrices" className="w-full border-4 border-amber-400 shadow-8bit" />
            </div>
          </FramerReveal>
          ...
          <FramerReveal>
            <div className="space-y-3">
              ...
              <img src={rocImg} alt="Model comparison metrics" className="w-full border-4 border-amber-400 shadow-8bit" />
            </div>
          </FramerReveal>
          ...
          <FramerReveal>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <img src={dtAccuracyImg} alt="Decision tree accuracy vs depth" className="w-full border-4 border-amber-400 shadow-8bit" />
              </div>
              <div className="space-y-3">
                <p className="font-pixel text-xs text-blue-400">DECISION BOUNDARIES — 7 CLASSIFIERS (RANGE vs FP_IDX)</p>
                <img src={decisionBoundaryImg} alt="Decision boundaries" className="w-full border-4 border-amber-400 shadow-8bit" />
              </div>
            </div>
          </FramerReveal>
        </div>
